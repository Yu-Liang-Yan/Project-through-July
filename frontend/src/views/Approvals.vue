  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <h2 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
        <CheckCircle class="w-7 h-7 text-primary-600" />
        {{ isGuardian ? '请求审批' : '我的请求' }}
      </h2>
      <button
    ...
    <!-- 发起请求表单（被保护用户） -->
    <div v-if="!isGuardian && showForm" class="bg-white rounded-lg shadow p-6 space-y-4">
    ...
    <template v-if="isGuardian">
      ...
      <div v-else-if="pendingRequests.length === 0" class="bg-white rounded-lg shadow p-8 text-center text-gray-500">
    ...
    <template v-if="!isGuardian">
      ...
      <div v-else-if="myRequests.length === 0" class="bg-white rounded-lg shadow p-8 text-center text-gray-500">
